...
def create_contract():
    ...
    new_contract = Contract(public_id=str(uuid.uuid4()), user_id=data['user_id'], project_id=data['project_id'], name=data['name'])
...
def create_rules(rules_id):
    ...
    new_rules = Rules(square=data['square'], rooms=data['rooms'], toilets=data['toilets'], contract_id=data['contract_id'])
